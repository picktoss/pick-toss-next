...
export const SearchInput = forwardRef<HTMLInputElement, Props>(({ ...rest }, ref) => {
  return (
...
function XIcon({ className }: { className?: HTMLElement['className'] }) {
  return (
    ...
    >
      ...
      <path d="M8 8L16 16" stroke="#A2A6AB" stroke-width="2" stroke-linecap="round" />
      <path d="M16 8L8 16" stroke="#A2A6AB" stroke-width="2" stroke-linecap="round" />
    </svg>
  )
}
