...
export function TodayQuiz() {
  return (
    <>
      ...
      <section className="mt-[172px] hidden bg-orange-gradient xl:block">
        <div className="mx-auto flex max-w-[1032px] *:shrink-0">
          <TodayQuizScreenIcon svgKey="desktop-today-quiz-screen" className="h-[723px] w-[537px]" />
          <div className="ml-[-40px] pt-[157px]">
            <FireworkIcon svgKey="desktop-firework" className="ml-[-12px] h-[68.9px] w-[74px]" />
