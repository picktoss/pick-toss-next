...
import Text from '@/shared/components/ui/v3/text'
import Icon from '@/shared/components/custom/icon'
import INFINITE_STAR_IMG from '@/../../public/images/infinite-star.png'
...
const PaymentPage = () => {
  ...
  return (
    <main className="flex h-[calc(90dvh-54px)] w-full flex-col gap-[30px] overflow-y-auto overflow-x-hidden">
      <div className="flex w-full grow flex-col items-center justify-center">
        <div className="relative h-[calc(24dvh*1.2)] w-[24dvh] flex-col">
          <Image src={INFINITE_STAR_IMG.src} fill alt="" className="justify-self-center" />
        </div>
